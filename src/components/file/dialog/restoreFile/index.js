 ...
 */
const initInstanceRestoreFile = (deleteBatchNum, filePath,fileInfo) => {
...
const showRestoreFileDialog = (obj) => {
	...
	let { deleteBatchNum, filePath,fileInfo} = obj
	return new Promise((reslove) => {
		initInstanceRestoreFile(deleteBatchNum, filePath,fileInfo)
